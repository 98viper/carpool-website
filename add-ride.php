                                            ...
                                            <nav id="nav" class="main-navigation">
                                                ...
                                                <ul class="navigation">
                                                    ...
                                                    <li>
														...
														<ul class="sub-menu">
														 <li>
															<a href="add-ride.php">Annoncer Un Trajet</a>
														 </li>
														 <li>
														  <?php $login=$_GET['login'];
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="sub-menu">
															...
															echo "<a href=updateconduct.php?login=$login>Modifier</a>"
															?> 
                    ...
                    <div class="col-sm-12 col-md-12 col-xs-12">
                        ...
                        <div class="page-content add-new-ride">
                            ...
                            <form action="addtrajet.php" method="get"  target="_self">
								...
								<div class="field">
									<label>Confirmez votre login (username) :  </label>
								...
								<br>
                                <div class="field">
                                    <input name="datevo" type="date" placeholder="Date" class="datepicker">
                                </div>
								...
								<input name="heurepick" type="text" ">
                                </div>
								
                                <div class="field">
                                   <label>Etat du trajet </label>
								...
								<table>
								<tr>
								<td><input type="radio" onclick="javascript:yesnoCheck();" name="etape" value="sans" /> <label>Sans Etape</label></td><td>
								<input type="radio" onclick="javascript:yesnoCheck();" name="etape" value="avec" /> <label>Avec Etape</label></td>
								</tr>
								</table>
								...
								<div >
									...
									<div class="field">
										<select id="from" name="frome">
											<option value="default">From (Etape)</option>
											<option>Sofia</option>
											<option>Plovdiv</option>
											<option>Hamburg</option>
											<option>Milano</option>
									...
									<div class="field">
										<select id="to" name="toe">
											<option value="default">To (Etape)</option>
											<option>Sofia</option>
											<option>Plovdiv</option>
											<option>Hamburg</option>
											<option>Milano</option>
									...
									<br>
									<div class="field">
										<label>Heure de depart (Etape) </label>
										<input name="heuret" type="text">
									</div>
								
								    <div class="field">
										<label>Prix (Etape) </label>
										<input name="prixe" type="text"> 
									</div>
