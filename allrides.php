    ...
    <head>
	  ...
	  <body>
        ...
        <section class="main-content">
			 <form action  ="deleteride.php"  	method="get"       target="_self"> 
	 
<?php

$m = mysqli_connect('localhost','root','','covoiturage');  

$reqall="select * from trajet";
...
<table width=100% >
	<tr>
	<td> <h3>NumTrajet </h3></td> <td><h3> Num Conducteur </h3></td> 
...
echo"
	<tr>
	<td>".$numtrj."</td> <td> ".$row[1]." </td> <td> ".$row[2]." </td><td>".$row[11]." </td>
	<td>".$row[3]." </td><td>".$row[4]." </td><td>".$row[5]." </td><td>".$row[6]." </td><td>".$row[7]." </td>
	<td>".$row[8]." </td><td>".$row[10]." </td><td>".$row[9]." </td>
	<td><a href=deleteride.php?numtrj=".$numtrj.">Delete</a></td>
