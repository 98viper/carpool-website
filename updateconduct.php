...
<!-- [if (gte IE 9)|!(IE)]><!--> <html class="not-ie no-js" lang="en">  <!--<![endif] -->
    <head>
        ...
        <!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title>Modifier compte conducteur</title>
 ...
 <form action="updateconducte.php" >
							<fieldset>
								<table width=100%>

								 <tr>
   <td> 
   <label> Confirmer votre Login (Username) </label>  
    </td> 
    <td> 
   ...
   <td> 
   <label> Nouveau  Login (Username) </label> 
    </td> 
  <td> 
  ...
  <input type="date" name="datenaiss">
   ...
   <td> Etat Fumeur </td>
   <td>
	<input type="radio" name="fum" value="fume"  /> <label>Fumeur</label></td><td>
	<input type="radio" name="fum" value="nofume"  /> <label>Non Fumeur</label>
	</td>
   </tr>
...
<div class="field buttons">
		<button value="sub" name="ok" type="submit" class="btn btn-lg green-color"> Modifier ! </button>
		</div>
</fieldset>
</form>
